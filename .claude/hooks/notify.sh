...
#
# Self-bootstraps a clone of terminal-notifier.app with Claude.app's icon so
# notifications display the Claude icon (terminal-notifier's -sender bundle-ID
# spoofing is broken on macOS Sonoma+; this is the reliable workaround).
#
